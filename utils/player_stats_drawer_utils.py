...
def draw_player_stats(output_video_frames, player_stats):
    for index, row in player_stats.iterrows():
        ...
        player_1_num_shots = row['player_1_number_of_shots']
        player_2_num_shots = row['player_2_number_of_shots']
        ...
        text = f"{player_1_num_shots} shots    {player_2_num_shots} shots"
