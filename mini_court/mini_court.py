...
class MiniCourt():
    ...
    def get_mini_court_coordinates(self, object_position, closest_key_point, closest_key_point_index, player_height_in_pixels, player_height_in_meters):
        ...
        # converting to mini court coordinates
    ...
    def convert_bounding_boxes_to_mini_court_coordinates(self, player_boxes, ball_boxes, original_court_keypoints):
        ...
        for frame_num, player_bbox in enumerate(player_boxes):
            ...
            closest_player_id_to_ball = min(player_bbox.keys(), key=lambda x: distance(ball_position, get_foot_position(player_bbox[x])))
            ...
            for player_id, bbox in player_bbox.items():
                ...
                closest_key_point_index = get_closest_keypoint_index(foot_position, original_court_keypoints, [0,2,12,13])
                closest_key_point = (original_court_keypoints[closest_key_point_index*2], original_court_keypoints[closest_key_point_index*2+1])
                ...
                if closest_player_id_to_ball == player_id:
                    closest_key_point_index = get_closest_keypoint_index(ball_position, original_court_keypoints, [0,2,12,13])
                    closest_key_point = (original_court_keypoints[closest_key_point_index*2], original_court_keypoints[closest_key_point_index*2+1])
